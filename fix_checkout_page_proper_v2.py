...
'''
    ...
    with open('checkout_route_fix.py', 'w', encoding='utf-8') as f:
...
'''
    ...
    with open('templates/checkout_proper.html', 'w', encoding='utf-8') as f:
...
'''
    ...
    with open('process_checkout_fix.py', 'w', encoding='utf-8') as f:
...
'''
    ...
    with open('create_sample_locations.py', 'w', encoding='utf-8') as f:
